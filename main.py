...
import os
known_faces_dir = '/Users/manoj/Downloads/python-attendance'         # Directory containing known face images
known_faces = []                                                     # Load known faces
known_names = []
...
def capture_image():                                                 # Function to capture image
...
def recognize_face(captured_image):                                    # Function to recognize face
    ...
    return None
def mark_attendance(student_name, file='attendance.xlsx'):              # Function to mark attendance
    now = datetime.now()
